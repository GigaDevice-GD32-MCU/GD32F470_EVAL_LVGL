...
#define LV_SDRAM_BUFFER _Pragma("location=\"SDRAM\"") _Pragma("data_alignment=32") __no_init
#define LV_BUFFER_ALIGN
#else
#define LV_SDRAM_BUFFER __attribute__((section("SDRAM")))
#define LV_BUFFER_ALIGN __attribute__((aligned(32)))
#endif
...
#elif(LV_BUF_TYPE==2)
/* TLI buf */
LV_SDRAM_BUFFER LV_BUFFER_ALIGN lv_color_t buf_disp[LV_HOR_RES_MAX * LV_VER_RES_MAX];
/* LVGL buf */
#define LV_BUF_SIZE (LV_HOR_RES_MAX * 200/sizeof(lv_color_t))
LV_SDRAM_BUFFER LV_BUFFER_ALIGN lv_color_t buf_2_1[LV_BUF_SIZE];
LV_SDRAM_BUFFER LV_BUFFER_ALIGN lv_color_t buf_2_2[LV_BUF_SIZE];
#else
/* LVGL buf  TLI buf */
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    /* wait until the previous IPA transfer has really finished */
    while(1U == g_ipa_flag){
    }
